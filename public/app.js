...
;// CONCATENATED MODULE: ./plugins/vnnative3-console/console.ts
...
/* harmony default export */ const vnnative3_console_console = (VnNative3ConsoleCore);

;// CONCATENATED MODULE: ./plugins/vnnative3-webview/HTML404.ts
...
/* harmony default export */ const HTML404 = (VnNative3HTML404);
...
var VnNative3RouterStruct = /** @class */ (function () {
    ...
    VnNative3RouterStruct.prototype.set = function (data) {
        try {
            ...
            return (new vnnative3_console_console).error(e.toString());
        }
    };
        ...
        try {
            for (var i = 0; i < this.config.length; i++) {
                if (window.location.pathname === this.config[i].url) {
                    ...
                    (new this.config[i].page).beforeRender();
                    document.getElementById("root").innerHTML = (new this.config[i].page).render();
                    (new this.config[i].page).afterRender();
                    (new vnnative3_console_console).log('Welcome to Vn Native 3 Frame Work');
                    return;
                }
...
;// CONCATENATED MODULE: ./plugins/vnnative3-webview/HTMLElement/HTMLElement.ts
...
/* harmony default export */ const HTMLElement = (VnNative3HTMLElement);
